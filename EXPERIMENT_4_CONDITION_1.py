...
l1starty = screen_height/2
l1endx = screen_width/2 + 380
l1endy = screen_height/2

p1 = screen_width/2 + 365
p2 = screen_height/2 - 25
...
while True:
    ...
    pygame.draw.rect(screen, black, sq3)
    pygame.draw.rect(screen, black, sq4)
    pygame.draw.ellipse(screen, black, ci)
    pygame.draw.ellipse(screen, black, ci2)
    pygame.draw.ellipse(screen, black, ci3)
    pygame.draw.ellipse(screen, black, ci4)

    pygame.draw.polygon(
        screen, black, ((p1, p2), (l1startx, l1starty), (l1endx, l1endy)))
