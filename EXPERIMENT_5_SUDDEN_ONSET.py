...
l1startx = screen_width/2 + 310
l1starty = screen_height/2 - 15
l1endx = screen_width/2 + 270
l1endy = screen_height/2 - 15
l2startx = screen_width/2 + 285
l2starty = screen_height / 2 - 30
l2endx = screen_width/2 + 285
...
while True:
    ...
    pygame.draw.line(screen, gray, (l1startx, l1starty),
                     (l1endx, l1endy), 5)
    pygame.draw.line(screen, gray, (l2startx, l2starty),
                     (l2endx, l2endy), 5)
